...
@RepositoryRestResource(collectionResourceRel = "armorVersionAttacks", path = "armorVersionAttacks")
interface ArmorVersionAttackRepository : PagingAndSortingRepository<ArmorVersionAttack, Long> {
